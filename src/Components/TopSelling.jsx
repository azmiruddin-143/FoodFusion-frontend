...
const TopSelling = () => {
    ...
    return (
        <div>
            ...
            <p className='text-center mx-auto text-neutral mt-3 sm:w-6/12 lg:w-5/12 xl:w-4/12'>Explore our top-selling products, loved by customers for their exceptional quality and unbeatable value</p>

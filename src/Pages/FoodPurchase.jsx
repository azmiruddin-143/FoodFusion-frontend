            ...
            <div>
                ...
                <div className='my-10 sm:mx-10 mx-2 '>
                    <form onSubmit={PurchaseForm} className='max-w-md mx-auto p-5 rounded-md  bg-base-300' action="">
                        ...
                        {
                            sellerEmail === user?.email && <h1 className='text-red-600 mt-3'>You cannot buy your own product</h1>
                        }


                        <div className='w-full'>
                            <button disabled={sellerEmail === user?.email} className={`${sellerEmail === user?.email ? 'bg-[#dddada] text-[#a4a3a3] font-bold w-full py-2 px-3 my-5 rounded-lg' : "bg-primary-content text-primary font-bold w-full py-2 px-3 my-5 rounded-lg"}`}>Purchase</button>
                        </div>
                    </form>
